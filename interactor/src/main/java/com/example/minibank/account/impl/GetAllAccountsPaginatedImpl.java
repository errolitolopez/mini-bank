...
public class GetAllAccountsPaginatedImpl implements GetAllAccountsPaginated {
    ...
    @Override
    public PageDTO<AccountResponse> execute(PageRequest pageRequest) {
        final Page<User> userPage = userGateway.getAllUsersPaginated(pageRequest);
